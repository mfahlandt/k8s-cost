...
// scale.json is generated by `costctl collect-scale`; the tab shows a hint when
// it has not been generated yet.
function scaleUrl() {
  return `${import.meta.env.BASE_URL}scale.json`;
}

// Tab routing is hash based (#/overview, #/services, #/scale) so the static
// Pages deployment needs no server-side routes.
const VIEWS = ["overview", "services", "scale"];

function viewFromHash() {
  const h = typeof window !== "undefined" ? window.location.hash : "";
  return VIEWS.find((v) => h.includes(v)) || "overview";
}
